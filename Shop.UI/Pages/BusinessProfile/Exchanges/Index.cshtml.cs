...
namespace Shop.UI.Pages.BusinessProfile.Exchanges
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            ...
            vars.Add("invoiceno", Input.Number);
            vars.Add("contactmessage", Input.Comments);
            vars.Add("details", Input.Details);
            vars.Add("productsAndQty", Input.ProductsQuantity);
            ...
            _emailSender.SendEmailByTemplate(vars, "ExchangesAndReturns", m);
            //await _emailSender.sendSupportEmail("bronwinbergstedt@gmail.com", vars, "contact-us", m);

            return RedirectToPage("/Contact/Confirmation");
        }
        public void OnGet()
        {
